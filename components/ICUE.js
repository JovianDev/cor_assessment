  ...
  return (
    <div className="w-[full] h-full py-[4rem] px-20 md:p-2 m-0 bg-[url('/img/iCUE-panel-bg.jpg')] bg-no-repeat bg-cover flex justify-center md:flex-col">
      ...
      >
        ...
        <p className="text-lg text-stone-50 font-helvetica md:px-10 md:text-center">
        ...
        <input
          type="button"
          value="LEARN MORE"
          className="w-48 px-8 py-4 my-10 font-bold md:mb-20 md:w-96 bg-stone-50 font-helvetica hover:cursor-pointer hover:bg-stone-300 active:opacity-40 hover:shadow-md hover:animate-selectUp md:hover:animate-none"
        />
      </div>
